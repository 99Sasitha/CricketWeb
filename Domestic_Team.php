...
<div class="container">
		<div class="Team_Left" style="width:1300px;">
			<h2 style="text-align:center;font-weight: bold;"><?php echo $tournament_name; ?> Recent Updates & Results</h2>
    ...
    <div class="container first_innings_bat">
        <h2 class="Result_header"style="font-weight: bold;">Points Table:</h2>
    ...
    <div class="Team_Left" style="width:1300px;">
      <h2 class="Result_header" style="font-weight: bold;"><?php echo $tournament_name; ?> Results & Fixtures</h2>
            <div class=" showresult" style="width:600px;float:left;">
              <?php
                  $stt = "RUNNING";
                  $sql = "SELECT * FROM match_history WHERE match_type = '$tournament_name' AND match_status = '$stt' ORDER BY match_id DESC";
                  ...
                  ?>
                        <div class="result_list" style="text-align:center;">
                            <h2 class="Result_header" style="font-weight: bold;">Recents Results in <?php echo $tournament_name; ?> 2021</h2>
                            <br>
          ...
          <div class="result_list Team_Left" style="width:560px;float:left;">
                <h2 class="Result_header"style="font-weight: bold;">IPL 2021 Team List</h2>

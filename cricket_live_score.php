...
<div class = "homepic" >
          ...
          <div class = "homepic_left">
              <div  style="width: 100%; height: 50%;"  class="homepic_item" >
                      <div id="myCarousel" class="carousel slide" data-ride="carousel">
                          ...
                          <div class="carousel-inner" role="listbox">
                            ...
                            <div class="item active">
                              <img class="img-responsive center-block" src="https://i.pinimg.com/originals/6a/e6/8f/6ae68fd7e49200c6583b60b99d290e21.jpg" alt="Baghdad Premium" style="width:850px;height:590px">
                            ...
                            <div class="item">
                              <img class="img-responsive center-block" src="https://akm-img-a-in.tosshub.com/indiatoday/images/story/201701/wi-reuters_647_011517073038.jpg" alt="TR Travel" style="width:850px;height:590px">
                              <div class="carousel-caption">
                            ...
                            <div class="item">
                              <img class="img-responsive center-block" src="https://www.expressandstar.com/resizer/wwjjLVpmgoMVsRzCoakwRl6HBZk=/1000x0/filters:quality(100)/arc-anglerfish-arc2-prod-expressandstar-mna.s3.amazonaws.com/public/EWRNEBQYU5ECHKC7LPDUJPLZ3M.jpg" alt="Shohag Premium" style="width:850px;height:590px">
                              <div class="carousel-caption">
                            ...
                            <div class="item">
                              <img class="img-responsive center-block" src="https://img.xcitefun.net/users/2011/03/237878,xcitefun-world-cup-india-6.jpg" alt="Soudia Scania" style="width:850px;height:590px">
                              <div class="carousel-caption">
          ...
          <div class="homepic_score">
            ...
            <div class="live_score">
                <h3 style="color: white;font-weight: bold;">Live Scores and Recent Results</h3>
          ...
          <div class="live_fixture">
                <h3 style="color: white;font-weight: bold;">Fixtures</h3>
                <div class="fixture_list">
                    <?php
                    require('connectdb.php');
                    $stt = "FIXTURED";
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------- -->
      <div class="focus">
        <div class="news">
          <h3 style="font-weight: bold;">News Section</h3>
          <div class="">
        ...
        <div class="editorials">
            <h3 style="font-weight: bold;">Editorials</h3>
            <div class="">
        ...
        <div class="mostly_viewed">
          <h3 style="font-weight: bold;">Mostly Viewed News</h3>
          <div class="">
...
<h1></h1>
        ...
        <div class="social">
          ...
          <div class="poll">
              <h2 style="color:#000014;font-weight: bold;"><a name = "poll">POLL</a></h2>
